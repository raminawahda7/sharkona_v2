             ...
             <div className="col-sm-12">
              <form id="contactForm" name="sentMessage" novalidate="novalidate">
               ...
               <p className="help-block text-danger"></p>
                   ...
                   <div className="form-group">
                       <input className="form-control" id="Locationn" type="text" placeholder="Your Locationn  *" required="required" data-validation-required-message="Please enter your Locaton."/>
               <p className="help-block text-danger"></p>
                     </div>
